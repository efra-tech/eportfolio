      ...
      <div className='resume-back rc pb-2 pt-3' style={{overflowY: 'scroll'}}>
        ...
        <div>
          <p className='pt-4'><em style={{fontWeight: '900', textShadow: '1px 1px 1px black', fontSize: '1.62rem', fontStyle: 'normal'}}>Freelance Web Developer & Digital Designer&nbsp;&nbsp;</em>| &nbsp;May 2023 - Nov 2023</p>
            <p>I've worked on web and mobile projects for start-ups and companies based within Washington state. I individually provided service for webpage development, UX/UI design, and printed graphic design.</p>
      ...
      <div className='resume-back rc pb-2 pt-3' style={{overflowY: 'scroll', fontSize: '1.49rem'}}>
        ...
        <div className='d-flex mt-4'>
          <div>
            ...
            <p style={{marginTop: '-1.2%'}}>Successful completion of courses in building information technology, designing information experiences, and studying the use and impact of IT.</p>
        ...
        <div className='d-flex mt-5'>
          <div>
            ...
            <p style={{marginTop: '-1.2%'}}>Successful completion of credits for General Education and Pre-Medicine.</p>
