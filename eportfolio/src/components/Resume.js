...
export default function Resume(props) {
  ...
  return (
    <div className='a' style={{position: 'absolute', width:'98vw', left: '0', height: '13.7%', fontFamily: 'Montserrat, sans-serif'}}>
      <div style={{backgroundColor: 'lightgray', marginTop: '2.9%', height: '0.2rem', marginLeft: '21.5%', boxShadow: '0px 1px 2px white'}}></div>
      <div style={{backgroundColor: 'lightgray', marginTop: '1.4%', height: '0.2rem', marginLeft: '10%', boxShadow: '0px 1px 2px white'}}></div>
      <div className='d-flex mt-3' style={{paddingTop: '10px', paddingBottom: '100px', color: 'white', fontSize: '1.45rem'}}>
        ...
        <div onClick={handleClickPaper} className='latButton' style={{backgroundColor: '#4c76bd', borderRadius: '0.7rem', textAlign: 'center', marginRight: '1.4rem', width: '13.3rem', opacity: '70%'}}>
