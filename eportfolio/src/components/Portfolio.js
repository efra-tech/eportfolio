      ...
      <div className='carousal-parent' style={{position: 'static', width: '990px', marginTop: '2%', marginLeft: '19.4%', boxShadow: '28px 79px 220px rgba(255, 192, 203, 0.2085)'}}>
        <Carousel style={{backgroundColor: 'black', border: '8px solid black', borderRadius: '3rem', borderTop: '13px solid black'}}>
          <Carousel.Item style={{maxHeight: '650px'}}>
            ...
            <Carousel.Caption>
              <h5>
                <em>"Albertsons</em>&nbsp;to test <em>Veeve</em>&nbsp;smart shopping cart"&nbsp;&nbsp;- Supermarket News&nbsp;
                </h5>
          ...
          <Carousel.Item style={{maxHeight: '650px'}}>
            ...
            <Carousel.Caption>
              <h5 style={{marginBottom: '0px'}}><em>Veeve:</em>&nbsp;&nbsp;&nbsp;Smart Cart Start-Up</h5>
              <p className='pb-4 p'>Austin, Texas</p>
              <p style={{fontSize: '0.3rem'}}> &nbsp;</p>
            </Carousel.Caption>
          </Carousel.Item>
          ...
          <Carousel.Item style={{maxHeight: '650px'}}>
            ...
            <Carousel.Caption>
              <h5><em>YouFeed:</em>&nbsp;&nbsp;&nbsp;Landing Page & Early Start-Up</h5>
              <p className='pb-4 p'>Austin, Texas</p>
              <p style={{fontSize: '0.3rem'}}> &nbsp;</p>
            </Carousel.Caption>
          </Carousel.Item>
          ...
          <Carousel.Item style={{maxHeight: '650px'}}>
            ...
            <Carousel.Caption>
              <h5><em>NodeJS:</em>&nbsp;&nbsp;&nbsp;Open-Source System Software Guide&nbsp;&nbsp;&nbsp;
          ...
          <Carousel.Item style={{maxHeight: '650px'}}>
            ...
            <Carousel.Caption>
              <h5><em>Electric Vehicles in WA:</em>&nbsp;&nbsp;&nbsp;Interactive Data Analysis and App&nbsp;&nbsp;&nbsp;
