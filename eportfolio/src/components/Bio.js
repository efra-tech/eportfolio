      ...
      <div className='resume-backback p-2' style={{color:'white', marginTop: '-2.2%', height: '87.9%', width: '43%', borderTop: 'none', backgroundColor: '#11041e', marginRight: '19.0%', opacity: '1.5'}}>
        ...
        <div className='mx-4'>
          ...
          <div className='biobox pt-3' style={{textAlign: 'left'}}>
            ...
            <p>A bit about me:</p>
            <p>I started my undergraduate journey as a pre-med major, however, I soon realized that my interest and energy were truly captured while using a range of technologies in my extracurriculars, from graphic design tools all the way to a brain-computer interface. One of my favorite extracurriculars was the undergraduate neurotechnology club where I learned the use of technology on the brain, applied data programming to real-life applications, and ultimately became inspired to write and publish an <a rel="noreferrer" href='https://www.linkedin.com/posts/efra-ahsan-4b49a0228_hacking-consciousness-mindfulness-meditation-activity-7138436623712600064-NQeI/?utm_source=share&utm_medium=member_desktop' target='_blank'>article</a> about the neuroscience of consciousness hacking. I became fascinated with how humans consciously and subconsciously interact with technology; therefore, I switched my major to Informatics, with a focus in software engineering and development.</p>
            <p>I would not say I was a natural- I nearly failed my first web programming class. However, I took this as a challenge. With my love for coding fueling me, I ultimately conquered website development. In the undergraduate neurotechnology club, I led the development team and helped launch what is now <a href='https://synaptechuw.org/' target='_blank' rel='noreferrer'>www.synaptechuw.org</a>. I also led the development of my senior capstone project, for which I received an academic award. I have since then worked on a number of websites and app projects which are highlighted in my <a className='bio-p1-a' style={{fontWeight: '900'}} href='/portfolio'>portfolio</a>.</p>
            <p>I am seeking a full-time opportunity to apply and grow my skills in software development and engineering. I intend to continue learning IT professionally, with a goal to contribute to cutting-edge solutions that will make a long-lasting positive impact. I thrive working in collaborative environments where I can make meaningful connections and have stimulating exchange of ideas.</p>
