      ...
      <div className='resume-backback p-2' style={{color:'white', marginTop: '-2.2%', height: '87.9%', width: '43%', borderTop: 'none', backgroundColor: '#11041e', marginRight: '19.0%', opacity: '1.5'}}>
        ...
        <div className='mx-4'>
          ...
          <div className='biobox pt-3' style={{textAlign: 'left'}}>
            ...
            <p>I am seeking a full-time opportunity to apply and grow my skillset in application development, and work hands-on with cutting edge technology and like-minded engineers. I am curious to learn about technology from an enterprise level, and have goals to contribute to solutions that will make a long-lasting positive impact. I thrive working in collaborative environments where I can make meaningful connections and have stimulating exchange of ideas.</p>
            <p>With that, welcome to my website, and if you would like to connect over any opportunities or shared interests, I would be happy to meet!</p>
          </div>
