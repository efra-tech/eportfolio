  ...
  return (
    <div className='a' style={{position: 'absolute', width:'100vw', left: '0'}}>
      ...
      <div className='resume-backback p-2' style={{color:'white', marginTop: '-1.5%', height: '87.9%', width: '43%', borderTop: 'none', backgroundColor: '#11041e', marginRight: '19.0%', opacity: '1.5'}}>
        <img src={Efra} alt='my self portrait' style={{width: '31%', marginTop: '2.4%', borderRadius: '100%'}} />
        ...
        <div className='mx-4'>
          ...
          <div className='biobox pt-3' style={{textAlign: 'left'}}>
            ...
            <p>I am seeking a full-time opportunity to apply and grow my skillset working with applications, where I can work hands-on with cutting edge technologies and brilliant engineers. I am curious to learn about technology from an enterprise level, eager to stay in conversation on the industry and modern day design trends, and have goals to contribute to the educational sector. I thrive working in collaborative and fast-paced environments where I can have stimulating exchange of ideas. </p>
