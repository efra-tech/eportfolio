      ...
      <div className='resume-backback p-2' style={{color:'white', marginTop: '-1.5%', height: '87.9%', width: '43%', borderTop: 'none', backgroundColor: '#11041e', marginRight: '19.0%', opacity: '1.5'}}>
        ...
        <div className='mx-4'>
          ...
          <div className='biobox pt-3' style={{textAlign: 'left'}}>
            <p>Hi there! I am a recent graduate from the Informatics program at University of Washington. I have a passion for shaping the intersection that lies between technology and the frontiering for people. For quick reference, check out my <a className='bio-p1-a' style={{fontWeight: '900'}} href='/resume'>resume</a> and <a className='bio-p1-a' style={{fontWeight: '900'}} href='/portfolio'>portfolio</a>.</p>
            <p>A bit about me:</p>
            <p>I began my university studies initially as a pre-med major, however, was soon rooted into the product and application sciences. On campus, my interest and energy were truly captured in my extracirrcular hobbies with using a range of cool technologies, from graphic design tools to a data-collecting brain-computer interfaces, and application products. Most of my extracirrcicular involvement was with the undergraduate neurotechnology club, an underground tech hub, where I got to learn about mechanical uses of technology, apply data programming and introduced machine learning to real-life applications, and roundedly inspired there in to research and publish my first article as a student, a <a rel="noreferrer" href='https://www.linkedin.com/posts/efra-ahsan-4b49a0228_hacking-consciousness-mindfulness-meditation-activity-7138436623712600064-NQeI/?utm_source=share&utm_medium=member_desktop' target='_blank'>science article</a>, about the neuroscience of consciousness hacking. </p>
            <p>My second year of college, I decided to learn engineering as a next step from programming, and closely failed my first class in website development. I took it as a challenge, however, with my passion already in the field, and pushed myself to exceed. In the same undergraduate neurotechnology club, I learned to lead siteware development as originally a designer, and we launched <a href='https://synaptechuw.org/' target='_blank' rel='noreferrer'>www.synaptechuw.org</a>. I overcame my failure and fear of development course when I signed up as the lead engineer for my senior capstone project, an open-source community and culture app, a last chance to overcome my academic hurdle in engineering- and drove my team to recieve the Annual Capstone Research Award 2023 for our complete open-source application. I have since then worked on a number of websites and app projects, design and development in my personal scope, which are highlighted in my <a className='bio-p1-a' style={{fontWeight: '900'}} href='/portfolio'>portfolio</a>.</p>
            <p>I am seeking the opportunity today for my first full-time position, where I can apply my earned skills and education. I aspire to work at the enterprise level where I can bring my ambition and expertise to the next environment for my innovative journey. </p>
            <p>With that, welcome to my first personal website, and if you would like to chat over any opportunities or shared interests, I would be happy to connect. </p>
          </div>
