      ...
      <div className='resume-backback p-2' style={{color:'white', marginTop: '-1.5%', height: '87.9%', width: '43%', borderTop: 'none', backgroundColor: '#11041e', marginRight: '19.0%', opacity: '1.5'}}>
        ...
        <div className='mx-4'>
          ...
          <div className='biobox pt-3' style={{textAlign: 'left'}}>
            ...
            <p>A bit about me:</p>
            <p>I began university initially in pre-med, however, was soon rooted and drawn into the product and application sciences. On campus, my interest was actually truly captured in my extracirrculars in working with a range of cool technologies, from graphic design tools to data-collecting brain-computer interfaces, and digital web products. Most of my extracirrcicular involvement was with the undergraduate neurotechnology club, an underground tech hub, where I learned extensively about hard mechanics of technology, software data programming and introduced machine learning, and where I was wholly inspired there in to research and publish my first article as a student, a <a rel="noreferrer" href='https://www.linkedin.com/posts/efra-ahsan-4b49a0228_hacking-consciousness-mindfulness-meditation-activity-7138436623712600064-NQeI/?utm_source=share&utm_medium=member_desktop' target='_blank'>science article</a>, about the neuroscience of consciousness hacking. </p>
            <p>My second year of college, I decided to pursue an education in programming and technology, in which I actually failed my first class in website development. I took it as a challenge, however, and with my passion, pushed myself to exceed. In the same undergraduate neurotechnology club, I took on to lead the siteware development as originally a designer, and co-launched <a href='https://synaptechuw.org/' target='_blank' rel='noreferrer'>www.synaptechuw.org</a>. The next quarter, I signed up as the lead engineer for my senior capstone project, an open-source community and culture app, a last chance to overcome my academic hurdle in next-level programs- and drove my team to recieve the Annual Capstone Research Award 2023 for our complete open-source application. I have since then worked on a number of websites and app projects, design and development in my scoped expertise, which are highlighted in my <a className='bio-p1-a' style={{fontWeight: '900'}} href='/portfolio'>portfolio</a>.</p>
            <p>I am seeking the opportunity to work full-time in product development, where I can apply my experience and education with digital production and programs. I aspire to work for a company that pushes me to exceed, and where I can bring ambition and a learning mindset to the next environment for my innovative journey. </p>
            <p>With that, welcome to my first personal website, and if you would like to chat over any opportunities or shared interests, I would love to connect! </p>
          </div>
